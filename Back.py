...
def calculate_transaction_hash(data, remaining_time):
    data_string = str(data['bike_id']) + str(data['user_id']) + str(data['rental_time']) + str(remaining_time)
...
def devolver_bicicleta():
    ...
    transaction_hash = calculate_transaction_hash(transaction_data,remaining_time)
    ...
    return jsonify({'message': 'Bicicleta devolvida com sucesso', 'remaining_time': remaining_time,'hash':transaction_hash})
